...
mean_data <- read_xlsx("/Users/qiuyuyue/Documents/MRI/data/Vmri_mean_sd2024.xlsx", sheet = "mean")
# 将均值数据转换为长格式，方便后续匹配
mean_long <- mean_data %>%
...
# 顺序重排
zcombined_cols <- c(
  "Hippo_zcombined", "Amygdala_zcombined", "Entorhinal_zcombined", "Parahippo_zcombined",
  "Temp_Neo_zcombined",
